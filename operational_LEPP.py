...
alg = pickle.load(open("algorithms/dir_LEPP_d0.al","rb"))
alg1 = pickle.load(open("algorithms/dir_LEPP_d1.al","rb"))
...
title = "Actual mean absolute error meteorological model (kt): {}. Reference (m/s): 1.9\nActual mean absolute error machine learning (kt): {}. Reference (m/s): 0.74".format(mae_wrf,mae_ml)
ax.set_title(title)
...
# concat metars an forecast
df_res = pd.concat([df_for,metars["sn_l"]], axis = 1)
df_res_dropna = df_res.dropna()
...
#@title Precipitation
#open algorithm prec d0 d1
alg = pickle.load(open("algorithms/prec_LEPP_d0.al","rb"))
alg1 = pickle.load(open("algorithms/prec_LEPP_d1.al","rb"))
...
alg = pickle.load(open("algorithms/vis_LEPP_d0.al","rb"))
alg1 = pickle.load(open("algorithms/vis_LEPP_d1.al","rb"))
...
plt.grid(True, axis="both")
plt.title("Actual Heidke skill score meteorological model: {}. Reference: 0.08\nActual Heidke skill score machine learning: {}. Reference: 0.75".format(HSS_wrf,HSS_ml))
st.pyplot(fig)
...
alg = pickle.load(open("algorithms/temp_LEPP_d0.al","rb"))
alg1 = pickle.load(open("algorithms/temp_LEPP_d1.al","rb"))
...
#open algorithm temperature d0 d1
alg = pickle.load(open("algorithms/pres_LEPP_d0.al","rb"))
alg1 = pickle.load(open("algorithms/pres_LEPP_d1.al","rb"))
...
fig, ax = plt.subplots(figsize=(10,6))
df_res.dropna().plot(grid=True, ax=ax, color=["r","b","g"],linestyle='--');
title = "Actual mean absolute error meteorological model: {}. Reference:0.8\nActual mean absolute error machine learning: {}. Reference: 0.42 ".format(mae_wrf,mae_ml)
ax.set_title(title)
ax.grid(True, which = "both", axis = "both")
st.pyplot(fig)
